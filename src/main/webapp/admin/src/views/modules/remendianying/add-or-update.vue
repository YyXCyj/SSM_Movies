    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="电影解读" prop="dianyingjiedu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.dianyingjiedu" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.dianyingjiedu" label="电影解读" prop="dianyingjiedu">
                    <span v-html="ruleForm.dianyingjiedu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dianyingxiangqing = true;
          ...
          if(o=='dianyingjiedu'){
            this.ruleForm.dianyingjiedu = obj[o];
	    this.ro.dianyingjiedu = true;
            continue;
          }
          if(o=='thumbsupnum'){
	...
	this.ruleForm.dianyingxiangqing = this.ruleForm.dianyingxiangqing.replace(reg,'../../../ssm5kk10/upload');
	this.ruleForm.dianyingjiedu = this.ruleForm.dianyingjiedu.replace(reg,'../../../ssm5kk10/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
