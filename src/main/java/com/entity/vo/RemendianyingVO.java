...
public class RemendianyingVO  implements Serializable {
	...
	public void setDianyingjiedu(String dianyingjiedu) {
		this.dianyingjiedu = dianyingjiedu;
	}
	
	/**
	 * 获取：电影解读
	 */
	public String getDianyingjiedu() {
		return dianyingjiedu;
	}
